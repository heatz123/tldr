...
register(
    id="antmazediversestates-umaze-v2",
    entry_point="d4rl.locomotion.ant:make_ant_maze_env",
    # max_episode_steps=700,
    kwargs={
        "maze_map": maze_env.U_MAZE_TEST,
...
register(
    id="antmaze-large-playinthemiddle-v2",
    entry_point="d4rl.locomotion.ant:make_ant_maze_env",
    max_episode_steps=1000,
    kwargs={
        "maze_map": maze_env.HARDEST_MAZE_TEST_MIDDLE,
        "reward_type": "sparse",
        "dataset_url": "http://rail.eecs.berkeley.edu/datasets/offline_rl/ant_maze_v2/Ant_maze_hardest-maze_noisy_multistart_True_multigoal_False_sparse_fixed.hdf5",
        "non_zero_reset": False,
        "eval": True,
...
register(
    id="antmaze-custom-large-play-v2",
    entry_point="d4rl.locomotion.ant:make_ant_maze_env",
    max_episode_steps=1000,
    kwargs={
...
register(
    id="antmaze-custom-ultra-play-v0",
    entry_point="d4rl.locomotion.ant:make_ant_maze_env",
    max_episode_steps=2000,
    kwargs={
        "deprecated": True,
        "maze_map": maze_env.ULTRA_MAZE,
        "reward_type": "sparse",
        "non_zero_reset": False,
