...
register(
    id="maze2d-toymaze-v1",
    entry_point="d4rl.pointmaze:ToyMazeEnv",
    max_episode_steps=300,
    kwargs={
        "maze_spec": TOY_MAZE,
        "reward_type": "sparse",
...
register(
    id="maze2d-verylargefix-dense-v1",
    entry_point="d4rl.pointmaze:MazeEnv",
    max_episode_steps=800,
    kwargs={
        "maze_spec": VERY_LARGE_MAZE,
        "reward_type": "dense",
        "reset_target": False,
        "ref_min_score": 30.569041,
        "ref_max_score": 303.4857382709002,
