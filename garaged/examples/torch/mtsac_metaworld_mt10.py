...
def mtsac_metaworld_mt10(ctxt=None, seed=1, _gpu=None):
    ...
    mtsac.to()
    runner.setup(algo=mtsac, env=mt10_train_envs, sampler_cls=LocalSampler, n_workers=1)
