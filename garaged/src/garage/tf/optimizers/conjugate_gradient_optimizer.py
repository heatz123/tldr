...
class HessianVectorProduct(abc.ABC):
    ...
    def build_eval(self, inputs):
        ...
        def _eval(v):
            ...
            ret = (
                sliced_fun(self._hvp_fun["f_hx_plain"], self._num_slices)(inputs, xs)
                + self._reg_coeff * v
            )
            return ret
...
class ConjugateGradientOptimizer:
    ...
    def loss(self, inputs, extra_inputs=None):
        ...
        if extra_inputs is None:
            extra_inputs = tuple()
        return sliced_fun(self._opt_fun["f_loss"], self._num_slices)(
            inputs, extra_inputs
        )
    ...
    def constraint_val(self, inputs, extra_inputs=None):
        ...
        if extra_inputs is None:
            extra_inputs = tuple()
        return sliced_fun(self._opt_fun["f_constraint"], self._num_slices)(
            inputs, extra_inputs
        )
