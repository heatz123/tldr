...
class LSTMModule(MultiHeadedLSTMModule):
    """MLP Model.
    ...
    def forward(self, input_value, hidden_states=None):
        """Forward method.
        ...
        """
        output_val, hidden_states = super().forward(
            input_value, hidden_states=hidden_states
        )
        return output_val[0], hidden_states
