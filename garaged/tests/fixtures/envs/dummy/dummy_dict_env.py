...
class DummyDictEnv(DummyEnv):
    ...
    def __init__(self, random=True, obs_space_type="box", act_space_type="box"):
            ...
            return gym.spaces.Dict(
                {
                    "achieved_goal": gym.spaces.Box(
                        low=-200.0, high=200.0, shape=(3,), dtype=np.float32
                    ),
                    "desired_goal": gym.spaces.Box(
                        low=-200.0, high=200.0, shape=(3,), dtype=np.float32
                    ),
                    "observation": gym.spaces.Box(
                        low=-200.0, high=200.0, shape=(25,), dtype=np.float32
                    ),
                }
            )
