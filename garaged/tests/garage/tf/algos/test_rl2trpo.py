...
class TestRL2TRPO(TfGraphTestCase):
    ...
    def setup_method(self):
        ...
        self.policy = GaussianGRUPolicy(
            env_spec=self.env_spec, hidden_dim=64, state_include_action=False
        )
    ...
    def test_rl2_trpo_pendulum_default_optimizer(self):
        with LocalTFRunner(snapshot_config, sess=self.sess):
            ...
            assert isinstance(algo._inner_algo._optimizer, ConjugateGradientOptimizer)
