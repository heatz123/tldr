...
class TestGaussianCNNBaseline(TfGraphTestCase):
    ...
    def test_fit(self, obs_dim):
        ...
        with mock.patch(
            ("garage.tf.baselines." "gaussian_cnn_baseline." "GaussianCNNRegressor"),
    ...
    def test_obs_is_image(self):
        ...
        with mock.patch(
            ...
            with mock.patch(
                "garage.tf.baselines." "gaussian_cnn_baseline." "normalize_pixel_batch",
                side_effect=normalize_pixel_batch,
            ) as npb:
    ...
    def test_param_values(self, obs_dim):
        ...
        with mock.patch(
            ...
            gcb = GaussianCNNBaseline(env_spec=box_env.spec)
            new_gcb = GaussianCNNBaseline(
                env_spec=box_env.spec, name="GaussianCNNBaseline2"
            )
