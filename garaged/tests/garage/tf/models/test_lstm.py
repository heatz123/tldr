...
class TestLSTM(TfGraphTestCase):
    ...
    def test_output_shapes(
        self, time_step, input_dim, output_dim, hidden_init, cell_init
    ):
        ...
        full_output = self.sess.run(outputs_t, feed_dict={_input_var: obs_inputs})
    ...
    def test_output_value(
        ...
        cell1 = cell2 = np.full((self.batch_size, self.hidden_dim), cell_init.eval())
        ...
        full_output1 = self.sess.run(outputs_t, feed_dict={_input_var: obs_inputs})
    ...
    def test_output_same_as_rnn(
        ...
        full_outputs = self.sess.run(self.lstm[0], feed_dict={_input_var: obs_inputs})
