...
class TestCategoricalLSTMPolicy(TfGraphTestCase):
    ...
    @pytest.mark.parametrize(
        "obs_dim, action_dim, hidden_dim, obs_type",
        [
            ((1,), 1, 4, "discrete"),
            ((2,), 2, 4, "discrete"),
            ((1, 1), 1, 4, "discrete"),
    ...
    def test_get_action_state_include_action(
        self, obs_dim, action_dim, hidden_dim, obs_type
    ):
    ...
    def test_build_state_include_action(self, obs_dim, action_dim, hidden_dim):
        ...
        output2 = self.sess.run(
            [dist_sym.probs], feed_dict={state_input: [[concat_obs], [concat_obs]]}
        )
    ...
    def test_is_pickleable(self):
        ...
        with tf.compat.v1.Session(graph=tf.Graph()) as sess:
            ...
            output2 = sess.run(
                ...
                feed_dict={
                    policy_pickled.model.input: [[obs.flatten()], [obs.flatten()]]
                },
            )  # noqa: E126
            assert np.array_equal(output1, output2)
