...
def test_dqn_pong():
    ...
    assert (
        subprocess.run(
            [
                str(EXAMPLES_ROOT_DIR / "tf/dqn_pong.py"),
                "--buffer_size",
                "5",
                "--max_path_length",
                "5",
...
def test_ppo_memorize_digits():
    ...
    env["GARAGE_EXAMPLE_TEST_N_EPOCHS"] = "1"
    command = [
        str(EXAMPLES_ROOT_DIR / "tf/ppo_memorize_digits.py"),
        "--batch_size",
        "4",
    ]
...
def test_step_env():
    ...
    assert (
        subprocess.run(
            [str(EXAMPLES_ROOT_DIR / "step_env.py"), "--n_steps", "1"], check=False
        ).returncode
        == 0
    )
...
def test_rl2_ppo_metaworld_ml10():
    ...
    assert (
        subprocess.run(
            [
                str(EXAMPLES_ROOT_DIR / "tf/rl2_ppo_metaworld_ml10.py"),
                "--n_epochs",
                "1",
                "--episode_per_task",
                "1",
...
def test_mtppo_metaworld_mt10():
    ...
    assert (
        subprocess.run(
            [
                str(EXAMPLES_ROOT_DIR / "torch/mtppo_metaworld_mt10.py"),
                "--epochs",
                "1",
                "--batch_size",
                "1",
...
def test_mtppo_metaworld_mt50():
    ...
    assert (
        subprocess.run(
            [
                str(EXAMPLES_ROOT_DIR / "torch/mtppo_metaworld_mt50.py"),
                "--epochs",
                "1",
                "--batch_size",
                "1",
...
def test_trpo_metaworld_mt10():
    ...
    assert (
        subprocess.run(
            [
                str(EXAMPLES_ROOT_DIR / "torch/mttrpo_metaworld_mt10.py"),
                "--epochs",
                "1",
                "--batch_size",
                "1",
...
def test_trpo_metaworld_mt50():
    ...
    assert (
        subprocess.run(
            [
                str(EXAMPLES_ROOT_DIR / "torch/mttrpo_metaworld_mt50.py"),
                "--epochs",
                "1",
                "--batch_size",
                "1",
